...
const PEOPLE: Seed[] = [
  ...
  { email: "a.elmarrouni@hari.ma", name: "Ahmed El marrouni", role: "EMPLOYEE", title: "Développeuse Full stack", department: "IT", location: "Tetouan", salary: 150000, manager: "manager@hari.ma", login: false, employmentType: "CONTRACTOR" },
